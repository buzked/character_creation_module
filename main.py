...
def attack(char_name: str, char_class: str) -> str:
    """Вычисление атаки."""
    message: str = ' нанёс урон противнику равный '
    if char_class == 'warrior':
        return f'{char_name} {message} {5 + randint(3, 5)}'
    if char_class == 'mage':
        return f'{char_name} {message} {5 + randint(5, 10)}'
    if char_class == 'healer':
        return f'{char_name}  {message} {5 + randint(-3, -1)}'
...
def special(char_name: str, char_class: str) -> str:
    """Финальные силы."""
    message: str = ' применил специальное умение '
    if char_class == 'warrior':
        return f'{char_name} {message}«Выносливость {80 + 25}»'
    if char_class == 'mage':
        return f'{char_name} {message}«Атака {5 + 40}»'
    if char_class == 'healer':
        return f'{char_name} {message}«Защита {10 + 30}»'


def start_training(char_name: str, char_class: str) -> str:
    """Тренеровочный процесс."""
    if char_class == 'warrior':
